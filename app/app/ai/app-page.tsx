...
import { AlertTriangle, Clipboard, Loader2, Sparkles, X } from "lucide-react";
...
export function AppPageClient() {
  ...
  const handleUpdate = async (taskData: {
    ...
    setIsUpdating(true);
    try {
      await api.put(`/api/v1/tasks/${taskList.id}`, taskData);

      // Update local state with the new data
      setTaskList((prev) => (prev ? { ...prev, ...taskData } : null));
      setTodosList(taskData.todos);
                ...
                {hasData ? (
                  <>
                    <div className="space-y-1.5">
                      ...
                      <div className="text-base font-medium p-2 rounded-md border">
                        {title || "Untitled"}
                      </div>
                    </div>
                    <div className="space-y-1.5">
                      ...
                      <div className="text-sm p-2 rounded-md border whitespace-pre-line min-h-[60px]">
                    ...
                    <div className="space-y-3">
                      ...
                      {hasTodos ? (
                        <TaskList todos={todosList} editable={false} />
                      ) : (
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  different database or use our template to create a compatible
                  one.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
