  ...
  return (
    <div
      ...
      className={cn(
        ...
        dragActive ? "border-emerald-600 bg-emerald-50/40" : "border-gray-300"
      )}
    ...
    >
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="text-sm text-gray-600">
          ...
          <button className="text-emerald-700 underline underline-offset-2" onClick={onBrowse} type="button">
            browse
          </button>
        </p>
        <p className="text-xs text-gray-500">Accepted: {accept.length ? accept.join(", ") : "Any"}</p>
      </div>
